...
pip3 install 'apache-airflow[mysql]==1.10.10'
...
curl https://raw.githubusercontent.com/apache/airflow/1.10.10/scripts/systemd/airflow -o /etc/default/airflow
sed -i -e 's#sysconfig#default#' /etc/default/airflow

curl https://raw.githubusercontent.com/apache/airflow/1.10.10/scripts/systemd/airflow.conf -o /etc/tmpfiles.d/airflow.conf

mkdir -p /usr/lib/systemd/system

curl https://raw.githubusercontent.com/apache/airflow/1.10.10/scripts/systemd/airflow-webserver.service -o /usr/lib/systemd/system/airflow-webserver.service
...
curl https://raw.githubusercontent.com/apache/airflow/1.10.10/scripts/systemd/airflow-scheduler.service -o /usr/lib/systemd/system/airflow-scheduler.service
...
pip3 install 'six>=1.14.0,<2.0.0'

# tabcmd
wget https://downloads.tableau.com/esdalt/2020.1.2/tableau-tabcmd-2020-1-2_all.deb -O /tmp/tableau-tabcmd-2020-1-2_all.deb
apt install -y /tmp/tableau-tabcmd-2020-1-2_all.deb
